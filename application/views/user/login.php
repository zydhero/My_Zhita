<? $this->view('header')?>
<link href="<?=base_url()?>style/登录.css" rel="stylesheet" type="text/css" />
<?$this->view('alert')?>
<div class="indexDiv">
    ...
    <br/>
        <div class="pic">
            ...
            <a href="" class="pic1"><img src="<?=base_url()?>image/新浪.png"></a>
            <a href="" class="pic1"><img src="<?=base_url()?>image/支付宝.png"></a>
        </div>
</div>
<? $this->view('footer')?>