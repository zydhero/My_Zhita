...
<link href="<?=base_url()?>style/项目投票1.css" rel="stylesheet" type="text/css" />
...
<div class="indexDiv">
    ...
    <div class="heading1">候选人名单及投票</div>
    	...
    	<?php foreach ($recommended_voting_project['voters'] as $voter) { ?>
					<li>
						<a href="<?=site_url()?>/space/<?= $voter['id'] ?>">

							 <img src="<?=base_url()?>uploads/images/avatar/<?=$voter['id']?>.jpg" height="30px" width="30px"/>
							<span>
								<?= $voter['name'] ?>
							</span>
						</a>
