	...
	var VoteFlags = (function(){
		...
		$(".voting table td.images").click(function(){
			...
			$(this).find("img:lt(" + (num + 1) + ")").each(function(){
				$(this).attr("src","http://demo.witower.com/style/flag.png");
				$.data(td, "num",(num+1));
			});
			$input.val(num+1);
			if(count === 3){
				$(".flags img").each(function(){
					$(this).attr("src","http://demo.witower.com/style/flag-off.png");
				});
			}else{
		...
		$(".voting .tail button[type='reset']").bind("click",function(e){
			...
			$(".voting table td.images img").attr("src","http://demo.witower.com/style/flag-off.png");
			$(".flags img").attr("src","http://demo.witower.com/style/flag.png");
		});
	}());
    ...
    Comment = (function () {
        $(".model").on("click", ".btn-comment", function () {
            ...
            .on('click', '[name="comment-content-submit"]', function () {
                ...
                //var postUrl = 'http://localhost/WITOWER/index.php/user/addstatuscomment/100';
                //alert(postUrl);
                //
                //$.post(postUrl, {commentContent: commentContent}, function (response) {
                //    alert(response);
                ...
                $.post("http://localhost/WITOWER/index.php/user/addstatuscomment/100", {commentContent: commentContent},
                    function (response) {
